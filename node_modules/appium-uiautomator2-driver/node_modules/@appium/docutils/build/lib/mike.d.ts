export class Mike {
     ...
     */
    exec(mikeCmd: string, mikeArgs?: string[] | undefined, verify?: boolean | null | undefined): Promise<import("teen_process").TeenProcessExecResult<Buffer> & import("teen_process").TeenProcessExecResult<string>>;
    /**
