...
const METHOD_MAP = /** @type {const} */ ({
    ...
    '/session/:sessionId/appium/device/gsm_signal': {
        POST: {
            command: 'gsmSignal',
            payloadParams: {
                validate: (jsonObj) => !support_1.util.hasValue(jsonObj.signalStrength) &&
                    !support_1.util.hasValue(jsonObj.signalStrengh) &&
                ...
                makeArgs: (jsonObj) => [
                    support_1.util.hasValue(jsonObj.signalStrength) ? jsonObj.signalStrength : jsonObj.signalStrengh,
                ],
            },
        },
    },
